        ...
        pub mod variables {
            ...
            pub fn get(name: &str) -> Result<Option<_rt::String>, ErrorCode> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "yosh:plugin/variables@0.2.9")]
                    extern "C" {
                        #[link_name = "get"]
        ...
        pub mod filesystem {
            ...
            pub fn cwd() -> Result<_rt::String, ErrorCode> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "yosh:plugin/filesystem@0.2.9")]
                    extern "C" {
                        #[link_name = "cwd"]
        ...
        pub mod files {
            ...
            pub fn read_file(path: &str) -> Result<_rt::Vec<u8>, ErrorCode> {
                unsafe {
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "yosh:plugin/files@0.2.9")]
                    extern "C" {
                        #[link_name = "read-file"]
                        fn wit_import(_: *mut u8, _: usize, _: *mut u8);
                    }
        ...
        pub mod io {
            ...
            pub fn write(target: IoStream, data: &[u8]) -> Result<(), ErrorCode> {
                unsafe {
                    ...
                    let ptr1 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "yosh:plugin/io@0.2.9")]
                    extern "C" {
                        #[link_name = "write"]
        ...
        pub mod commands {
            ...
            pub fn exec(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "yosh:plugin/commands@0.2.9")]
                    extern "C" {
                        #[link_name = "exec"]
                        fn wit_import(
                            _: *mut u8,
        ...
        pub mod settings {
            ...
            pub fn read() -> Result<Option<_rt::String>, ErrorCode> {
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "yosh:plugin/settings@0.2.9")]
                    extern "C" {
                        #[link_name = "read"]
                        fn wit_import(_: *mut u8);
                    }
    ...
    pub mod yosh {
        ...
        pub mod plugin {
            ...
            pub mod plugin {
                ...
                macro_rules! __export_yosh_plugin_plugin_0_2_9_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        "yosh:plugin/plugin@0.2.9#on-unload"] unsafe extern "C" fn
                        export_on_unload() { $($path_to_types)*::
                        _export_on_unload_cabi::<$ty > () } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_yosh_plugin_plugin_0_2_9_cabi;
                #[repr(align(1))]
            ...
            pub mod hooks {
                ...
                #[doc(hidden)]
                macro_rules! __export_yosh_plugin_hooks_0_2_9_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "yosh:plugin/hooks@0.2.9#pre-exec"] unsafe extern "C" fn
                        export_pre_exec(arg0 : * mut u8, arg1 : usize,) {
                        $($path_to_types)*:: _export_pre_exec_cabi::<$ty > (arg0, arg1) }
                        #[export_name = "yosh:plugin/hooks@0.2.9#post-exec"] unsafe
                        ...
                        "yosh:plugin/hooks@0.2.9#on-cd"] unsafe extern "C" fn
                        export_on_cd(arg0 : * mut u8, arg1 : usize, arg2 : * mut u8, arg3
                        : usize,) { $($path_to_types)*:: _export_on_cd_cabi::<$ty >
                        (arg0, arg1, arg2, arg3) } #[export_name =
                        "yosh:plugin/hooks@0.2.9#pre-prompt"] unsafe extern "C" fn
                        export_pre_prompt() { $($path_to_types)*::
                        _export_pre_prompt_cabi::<$ty > () } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_yosh_plugin_hooks_0_2_9_cabi;
            }
        }
    }
}
...
macro_rules! __export_plugin_world_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::yosh::plugin::plugin::__export_yosh_plugin_plugin_0_2_9_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::yosh::plugin::plugin);
        $($path_to_types_root)*::
        exports::yosh::plugin::hooks::__export_yosh_plugin_hooks_0_2_9_cabi!($ty
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:yosh:plugin@0.2.9:plugin-world:encoded world"]
#[doc(hidden)]
...
\x04\0\x0bplugin-info\x03\0\x08\x03\x01\x17yosh:plugin/types@0.2.9\x05\0\x02\x03\
...
\x03\x01\x1byosh:plugin/variables@0.2.9\x05\x02\x01B\x08\x02\x03\x02\x01\x01\x04\
...
gin/filesystem@0.2.9\x05\x03\x01B\x1a\x02\x03\x02\x01\x01\x04\0\x0aerror-code\x03\
...
.9\x05\x04\x02\x03\0\0\x09io-stream\x01B\x08\x02\x03\x02\x01\x05\x04\0\x09io-str\
...
:plugin/io@0.2.9\x05\x06\x01B\x09\x02\x03\x02\x01\x01\x04\0\x0aerror-code\x03\0\0\
...
exec\x01\x07\x03\x01\x1ayosh:plugin/commands@0.2.9\x05\x07\x01B\x06\x02\x03\x02\x01\
\x01\x04\0\x0aerror-code\x03\0\0\x01ks\x01j\x01\x02\x01\x01\x01@\0\0\x03\x04\0\x04\
read\x01\x04\x03\x01\x1ayosh:plugin/settings@0.2.9\x05\x08\x02\x03\0\0\x0bplugin\
...
unload\x01\x07\x04\x01\x18yosh:plugin/plugin@0.2.9\x05\x0a\x01B\x08\x01@\x01\x07\
...
\x02\x01@\0\x01\0\x04\0\x0apre-prompt\x01\x03\x04\x01\x17yosh:plugin/hooks@0.2.9\
\x05\x0b\x04\x01\x1eyosh:plugin/plugin-world@0.2.9\x04\0\x0b\x12\x01\0\x0cplugin\
