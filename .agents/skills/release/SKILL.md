...
Run: `.Codex/skills/release/scripts/release.sh test`

If exit code is non-zero, surface stderr verbatim and stop.

### Phase 3: Version bump

Run: `.Codex/skills/release/scripts/release.sh bump`
...
Run: `.Codex/skills/release/scripts/release.sh publish`
...
Run: `.Codex/skills/release/scripts/release.sh push`
